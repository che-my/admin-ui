...
const onClick = () => {
    isShow.value && onKeydown()
}
</script>

<template>
  <teleport to="#app">
    <div id="search" :class="{ searching: isShow }" @click="onClick">
      <div class="container">
        <div class="search-box" @click.stop>
          ...
          <div v-if="settingsState.mode === 'pc'" class="tips">
            <div class="tip">
        ...
        <div ref="search" class="result" :class="{ mobile: settingsState.mode === 'mobile' }">
          <router-link
      ...
      .search-box {
        ...
        .tips {
          ...
          span {
            ...
            box-shadow: inset 0 -2px var(--el-fill-color-lighter),
              inset 0 0 1px 1px var(--el-fill-color-darker);
          }
        }
      }
      .result {
